...
void main() {
  ...
  // getAuthHeader(), currentUser) that has been replaced by OAuth2
  // authentication. The corresponding methods in AuthService are now
  // commented out. These tests are preserved for reference.
